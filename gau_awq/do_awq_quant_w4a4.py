...
def main():
    ...
    torch.save(awq_results_0, '/root/gau/Gau_transformer/models_save/awq_results_w4_0.pt')
    torch.save(awq_results_1, '/root/gau/Gau_transformer/models_save/awq_results_w4_1.pt')
    torch.save(awq_results_2, '/root/gau/Gau_transformer/models_save/awq_results_w4_2.pt')
    torch.save(awq_results_3, '/root/gau/Gau_transformer/models_save/awq_results_w4_3.pt')
